...
class BukuController extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('viewbuku/buku/buku',$data);
    ...
    public function input()
    {
        ...
        echo view('viewbuku/buku/input',$data);
    }
    ...
    public function edit($id)
    {
        ...
        echo view('viewbuku/buku/edit',$data);
    }
    ...
    public function ulasan($id)
{
    if (!$this->biasa()) {
        ...
        $on2='ulasanbuku.userID=students.user_id';
        $data['data']=$model->super_w('ulasanbuku', 'buku','students', $on,$on2, array('ulasanbuku.bukuID' => $id));

        $data['buku']=$model->getRow('buku',array('buku.bukuID' => $id));


        
        echo view('viewbuku/buku/ulasan',$data);
