...
class Classes extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('viewujian/users/classes/classes',$class);
    ...
    public function list($id)
    {
        ...
        echo view('viewujian/users/classes/list',$class);
    ...
    public function exams($id)
    {
        ...
        echo view('viewujian/users/classes/exams',$exams);
    ...
    public function input()
    {
        ...
        echo view('viewujian/users/classes/input', $data);
    }
    ...
    public function edit($id)
    {
        ...
        // echo view('viewujian/head');
        // echo view('viewujian/nav');
        echo view('viewujian/users/classes/edit',$user);
        // echo view('viewujian/footer');
