...
class Exams extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('viewujian/exams/exams',$exams);
    ...
    public function list($id)
    {
        ...
        // echo view('viewujian/head');
        // echo view('viewujian/nav');
        echo view('viewujian/exams/list',$data);
        // echo view('viewujian/footer');
...
//         // $questionIds[] = $questionid;
    ...
    public function detail($id)
    {
        ...
        echo view('viewujian/exams/detail',$exam);
    }
    ...
    public function student($id)
    {
        ...
        echo view('viewujian/exams/student',$exam);
    }
